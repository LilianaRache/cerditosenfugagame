 ...
 * @author basan
 */
public class VistaCasaMaderaController implements Initializable {
    ...
    String[] enfoqueAleatorio = new String[]{"matematicas", "geografia"};
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tituloCasa.setText("Casa de Madera");
        System.out.println("Progreso al iniciar ventana: " + barraProgreso.getProgress());
        mostrarVidas();
        
        if(Main.enfoqueCasaMadera == "adivinanzas"){
            obtenerPreguntaRespuestas(Main.enfoqueCasaMadera);  
        }else if(Main.enfoqueCasaMadera == "preguntas"){           
            int numeroAleatorio = (int)Math.floor(Math.random()*2);
            obtenerPreguntaRespuestas(enfoqueAleatorio[numeroAleatorio]);
        }
        ...
        try {
            ...
            if (source instanceof Button) {
                ...
                if (button.getId().equals("btnRespuesta1")) {
                    ...
                    Main.contador++;
                    if (respuesta && Main.progreso < 0.56 && Main.enfoqueCasaMadera == "adivinanzas") {
                        Main.enfoqueCasaMadera = "preguntas";
                        System.out.println("Enfoque cambiado a:" + Main.enfoqueCasaMadera);
                        Main.incrementarProgreso();
                        Parent cuartoRoot = FXMLLoader.load(getClass().getResource("/views/VistaCasaMadera.fxml"));
                        Stage stage = (Stage) button.getScene().getWindow();
                        Scene scene = new Scene(cuartoRoot);
                        stage.setScene(scene);
                        stage.show();
                    }else if(respuesta && Main.progreso >= 0.56 && Main.enfoqueCasaMadera == "adivinanzas"){
                        Main.enfoqueCasaMadera = "preguntas";
                        Parent cuartoRoot = FXMLLoader.load(getClass().getResource("/views/VistaCasaMadera.fxml"));
                        Stage stage = (Stage) button.getScene().getWindow();
                        Scene scene = new Scene(cuartoRoot);
                        stage.setScene(scene);
                        stage.show();
                    }else if(respuesta && Main.progreso >= 0.672 && Main.enfoqueCasaMadera == "preguntas"){
                        Main.enfoqueCasaMadera = "adivinanzas";
