 ...
 * @author basan
 */
public class VistaCasaPajaController implements Initializable {
    Reto reto;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tituloCasa.setText("Casa de Paja");
        ...
        try {
            ...
            if (source instanceof Button) {
                ...
                if (button.getId().equals("btnRespuesta1")) {
                    ...
                    Main.contador++;
                    if (respuesta && Main.progreso < 0.4) {
                        ...
                        stage.show();
                    }else if(respuesta && Main.progreso > 0.4){
                        Parent cuartoRoot = FXMLLoader.load(getClass().getResource("/views/VistaCasaMadera.fxml"));
                        Stage stage = (Stage) button.getScene().getWindow();
                        Scene scene = new Scene(cuartoRoot);
                        stage.setScene(scene);
